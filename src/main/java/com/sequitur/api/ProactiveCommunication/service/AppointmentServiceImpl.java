...
public class AppointmentServiceImpl implements AppointmentService {
    ...
    @Override
    public Page<Appointment> getAllAppointmentsByPsychologistId(Long psychologistId, Pageable pageable) {
        return appointmentRepository.findByPsychologistId(psychologistId, pageable);
    }
